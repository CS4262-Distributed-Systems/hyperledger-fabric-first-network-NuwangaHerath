...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Create a duplicate asset with a new owner
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset being duplication
     * @param newOwner the new owner
    ...
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newOwner) {
        ChaincodeStub stub = ctx.getStub();
        String assetJSON = stub.getStringState(assetID);
        String newAssetId = assetID + "duplicate";
        ...
        Asset duplicateAsset = new Asset(newAssetId, asset.getColor(), asset.getSize(), newOwner, asset.getAppraisedValue());
